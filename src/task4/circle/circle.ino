...
void draw_Circle(){
    ...
    // This function is prefrablly made for making "Circle" shape.


    // Covering 2nd quadrant of the circle 
    for(int i = 90; i >= 0; i--){
    ...
    // Covering 1st quadrant of the circle
    for(int i = 0; i <= 90; i--){
    ...
    // Covering 4th quadrant of the circle
    for(int i = 90; i >= 0; i--){
    ...
    // Covering 3rd quadrant of the circle
    for(int i = 0; i <= 90; i--){
